...
export default function SpecialOffers() {
  ...
  const nextSlide = () => {
    setDirection(1);
    setActiveIndex((prev) => (prev === specialOffers.length - 1 ? 0 : prev + 1));
  };

  const prevSlide = () => {
    setDirection(-1);
    setActiveIndex((prev) => (prev === 0 ? specialOffers.length - 1 : prev - 1));
  };
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-700 max-w-2xl mx-auto text-lg">
            Exclusive, limited-time creations from our chef that you won't want to miss.
          </p>
        </motion.div>
              ...
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="relative h-60 sm:h-80 lg:h-full min-h-[300px]">
                    ...
                    <div className="absolute top-6 left-6 bg-secondary text-white py-2 px-4 rounded-lg shadow-lg">
                      <div className="flex items-center">
                        <span className="font-bold text-lg">${specialOffers[activeIndex].price}</span>
                  ...
                  <div className="p-8 lg:p-12 flex flex-col justify-between">
                        ...
                        <div className="bg-accent/20 p-4 rounded-xl mb-8">
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-gray-600">{specialOffers[activeIndex].availability}</p>
                            </div>
                          </div>
                        </div>
                      </motion.div>
                    ...
                    >
                      <Button className="w-full sm:w-auto bg-secondary hover:bg-secondary/90 text-white text-lg px-8 py-6 h-auto rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 mb-4 sm:mb-0 sm:mr-4">
                        {specialOffers[activeIndex].buttonText}
                      </Button>
                      <a href="#reservation" className="flex items-center text-secondary font-medium hover:underline">
                        Contact for details
